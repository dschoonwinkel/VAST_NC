...
public:
    ...
    bool processSocketMessage (Vast::id_t socket, const char *msg, size_t size)
    {
        ...
        */
        ...
        else 
        {
            ...
            Vast::id_t server_socket_id = g_world->openSocket (_socket_server);
    ...
    void gatewayConnected (Vast::id_t host_id)
    {
...
private:
    ...
    map<Vast::id_t, Vast::id_t> _clients;    // record of active clients
    map<Vast::id_t, Vast::id_t> _servers;    // record of active servers
};
