...
public:
    ...
    void print_stat ()
    {
        ...
        {            
            ...
            fprintf (_fp, "[%lu, %lu] %10lu (%8lu/%8lu/%8lu) %10lu (%8lu/%8lu/%8lu)\t%s\t", host_id, id, sendstat.total, (size_t)sendstat.average, sendstat.maximum, sendstat.minimum, recvstat.total, (size_t)recvstat.average, recvstat.maximum, recvstat.minimum, str);
