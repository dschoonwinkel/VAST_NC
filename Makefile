...
.PHONY: all clean $(VASTnet) $(VAST) $(VASTsim) $(common) $(random_walkertalker) $(demo_chatva_Qt) $(vaststat_replay) $(vaststat_replay_Qt)
...
all: $(common) $(VASTnet) $(VAST) $(VASTsim) $(random_walkertalker) $(demo_chatva_Qt) $(vaststat_replay) $(vaststat_replay_Qt)
...
$(VAST) $(VASTsim) $(common) $(VASTnet) $(random_walkertalker) $(demo_chatva_Qt) $(vaststat_replay) $(vaststat_replay_Qt):
